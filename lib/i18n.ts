...
export const translations = {
  en: {
    ...
    blendSituation: {
      title: "Today's blend situation",
      highRisk: "High FFA risk",
      onTrack: "On track",
      highRiskText: "Incoming CPO is high in FFA. Blending is recommended to meet the target quality.",
      onTrackText: "Incoming CPO quality is manageable. Blending keeps stock within the good FFA limit.",
      incomingCpo: "Incoming CPO",
      highFfaStock: "High-FFA stock",
      targetDispatchFfa: "Target dispatch FFA",
      projectedAfterBlending: "Projected after blending",
      confidence: "Confidence",
      confidenceHigh: "High",
      confidenceMedium: "Medium",
      confidenceLow: "Low",
      viewRecommendedBlend: "View recommended blend",
      generateBestPlan: "Generate best blend plan",
    },
    forecast: {
    ...
    allocation: {
      ...
      addBst: "Add tank",
      useBestPlan: "Generate Best Blend Plan",
      applyRecommended: "Apply recommended allocation",
    },
    tanks: {
      title: "Tank readings & allocation",
      subtitle: "Review each tank's stock, FFA and available capacity before generating the blend plan.",
      name: "Tank name",
  ...
  bm: {
    ...
    blendSituation: {
      title: "Situasi campuran hari ini",
      highRisk: "Risiko FFA tinggi",
      onTrack: "Mengikut landasan",
      highRiskText: "CPO masuk tinggi FFA. Percampuran disyorkan untuk penuhi kualiti sasaran.",
      onTrackText: "Kualiti CPO masuk boleh diurus. Percampuran mengekalkan stok dalam had FFA baik.",
      incomingCpo: "CPO masuk",
      highFfaStock: "Stok FFA tinggi",
      targetDispatchFfa: "Sasaran FFA despatch",
      projectedAfterBlending: "Jangkaan selepas campuran",
      confidence: "Keyakinan",
      confidenceHigh: "Tinggi",
      confidenceMedium: "Sederhana",
      confidenceLow: "Rendah",
      viewRecommendedBlend: "Lihat campuran disyorkan",
      generateBestPlan: "Jana pelan campuran terbaik",
    },
    forecast: {
    ...
    allocation: {
      ...
      useBestPlan: "Jana Pelan Campuran Terbaik",
      applyRecommended: "Guna peruntukan disyorkan",
    },
    tanks: {
      title: "Bacaan tangki & peruntukan",
      subtitle: "Semak stok, FFA dan kapasiti available setiap tangki sebelum menjana pelan campuran.",
      name: "Nama tangki",
