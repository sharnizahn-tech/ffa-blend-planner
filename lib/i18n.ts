...
export const translations = {
  en: {
    ...
    forecast: {
      ...
      utilisation: "Mill speed (%)",
      expectedOer: "Oil yield (%)",
      incomingFfa: "Incoming FFA",
    ...
    transferCalc: {
      ...
      notEnoughStock: "Source tank doesn't have that much stock.",
  ...
  bm: {
    ...
    forecast: {
      ...
      utilisation: "Kelajuan kilang (%)",
      expectedOer: "Hasil minyak (%)",
      incomingFfa: "FFA masuk",
    ...
    transferCalc: {
      ...
      notEnoughStock: "Tangki sumber tidak mempunyai stok sebanyak itu.",
